...
const CASE_STUDY_STEPS = [
  ...
  {
    pillar: "Delivery",
    action: "The final app was shipped, verified with real users, and handed over to the client with full documentation. The loop closed — value reached the end recipient."
  }
];
const METRICS = [
...
const PILLARS$1 = [
  ...
  },
  {
    ...
    icon: CircleCheckBig,
    detail: "Hanuman's mission was complete only when Rama received his report, believed it, and could act on it. Delivery means the value reaches the end recipient — not just that work was done."
  }
];
const FLOW_STEPS = [
  "Purpose",
...
function FrameworkPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-28 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "Six pillars of execution — each a phase of the project and a quality of character. HEM is as much a leadership philosophy as a project methodology." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-5", children: PILLARS$1.map((pillar, idx) => {
...
const PILLARS = [
  ...
  { num: "06", title: "Delivery", icon: CircleCheckBig }
];
function HomePage() {
  const { navigate } = useRouter();
  useFadeIn();
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl shadow-card border border-border p-6 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-sm text-foreground", children: "6 Pillars of HEM" })
              ] }),
