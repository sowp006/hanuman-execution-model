...
const CASE_STUDY_STEPS = [
  {
    ...
    action: "Team defined the core mission: democratize food access in Tier-2 cities. OKRs mapped to social impact, not just revenue."
  },
  {
    pillar: "Strategic Planning",
    action: "30-day sprint roadmap created. Tech stack evaluated, competitor analysis done, risk register prepared before any line of code."
  },
  {
    pillar: "Courageous Execution",
    action: "MVP launched in 6 weeks despite resource constraints. Team embraced bold deadlines and shipped a working prototype on schedule."
  },
  {
    pillar: "Intelligent Adaptability",
    action: "After user testing revealed UX friction, the team pivoted the onboarding flow within one sprint — zero sunk-cost resistance."
  },
  {
    pillar: "Transparent Communication",
    action: "Weekly stakeholder demos, open Slack channels, and honest blocker reports eliminated surprise failures and built investor trust."
  }
];
const METRICS = [
...
function CaseStudyPage() {
  useFadeIn();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-28 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "Real-World Application" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-4", children: "Case Study" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold text-foreground mb-3", children: "HEM in Action: Building a Mobile App Startup" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "A food delivery startup applied HEM from Day 1. Here's how each pillar transformed their execution — and the results they achieved." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade bg-white rounded-3xl border border-border shadow-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 lg:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3 space-y-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-bold uppercase tracking-wider text-muted-foreground mb-6", children: "The HEM Journey" }),
        CASE_STUDY_STEPS.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full gold-bg flex items-center justify-center text-white text-xs font-bold shrink-0", children: idx + 1 }),
                idx < CASE_STUDY_STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold gold-text uppercase tracking-wider mb-1", children: step.pillar }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: step.action })
              ] })
            ]
          },
          step.pillar
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 flex flex-col gap-4 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1", children: "Outcomes" }),
        METRICS.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-accent rounded-2xl p-5 border border-amber-200",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-black gold-text leading-none mb-1", children: m.value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-foreground", children: m.label })
            ]
          },
          m.label
        ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 border border-amber-200 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-foreground mb-3", children: "Key Takeaway" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "HEM doesn't replace Agile or Scrum — it supercharges them with a values layer. Teams using HEM don't just move faster; they move with clarity, courage, and alignment that compounds over every sprint." })
    ] }) })
  ] });
}
...
function RouterProvider({ children }) {
  ...
  const navigate = reactExports.useCallback((page) => {
    setCurrentPage(page);
    window.scrollTo({ top: 0, behavior: "smooth" });
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RouterContext.Provider, { value: { currentPage, navigate }, children });
}
function useRouter() {
  return reactExports.useContext(RouterContext);
}
function ConclusionPage() {
  const { navigate } = useRouter();
  useFadeIn();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-28 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "Final Thoughts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-4", children: "Conclusion" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto", children: "Why Ethical Leadership Matters in Technology" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade relative bg-white rounded-3xl p-10 border border-border shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-6 left-8 text-6xl gold-text opacity-20 font-serif leading-none select-none", children: "“" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "text-xl leading-relaxed text-foreground font-medium relative z-10", children: [
        "Technology without ethics is power without wisdom. The Ramayana teaches us that even the most capable individual — Hanuman, who could alter his size, fly across oceans, and lift mountains — chose to serve a righteous purpose rather than his own ambition.",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "gold-text font-bold", children: [
          " ",
          "The future of engineering belongs to builders who combine technical excellence with moral clarity."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-6 right-8 text-6xl gold-text opacity-20 font-serif leading-none select-none", children: "”" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade grid sm:grid-cols-3 gap-4 text-center", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold gold-text", children: item.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: item.sub })
        ]
      },
      item.label
    )) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade bg-gradient-to-br from-amber-50 via-orange-50 to-amber-50 rounded-2xl p-8 border border-amber-200 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full gold-bg flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-2xl font-bold", children: "ॐ" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground mb-4", children: "The Hanuman Execution Model is a beginning, not an endpoint." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed max-w-2xl mx-auto", children: "Every project is a Yatra — a sacred journey toward a goal that matters. HEM gives engineers a vocabulary, a framework, and a moral compass for that journey. As India's technology sector grows, the builders who will shape it must be both technically excellent and deeply human. That is the promise of the Hanuman Execution Model." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
...
const PILLARS$1 = [
  {
    ...
    icon: Target,
    detail: "Hanuman's unwavering devotion to Rama was his 'why'. It guided every decision when he was alone in Lanka with no supervision."
  },
  {
    num: "02",
    ...
    icon: Map$1,
    detail: "Hanuman spent significant time studying Lanka before acting — its layout, guard rotations, and vulnerabilities. No step was taken without intelligence."
  },
  {
    num: "03",
    ...
    icon: Zap,
    detail: "The leap across the ocean had no guaranteed outcome. Hanuman committed fully because his purpose was clear. Conviction precedes competence."
  },
  {
    num: "04",
    title: "Adaptability",
    ...
    icon: RefreshCw,
    detail: "Hanuman changed size, disguised himself, and altered his approach multiple times in Lanka. Adaptability is not weakness — it is intelligence applied in motion."
  },
  {
    num: "05",
    title: "Communication",
    ...
    icon: MessageSquare,
    detail: "When Hanuman returned from Lanka, his detailed, honest report gave Rama and the Vanara army everything they needed to plan the final campaign with confidence."
  }
];
const FLOW_STEPS = [
  "Purpose",
...
function FrameworkPage() {
  useFadeIn();
  const lastPillar = PILLARS$1[4];
  const LastIcon = lastPillar.icon;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-28 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "Core Model" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-4", children: "The HEM Framework" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "Five pillars of execution — each a phase of the project and a quality of character. HEM is as much a leadership philosophy as a project methodology." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-5", children: PILLARS$1.slice(0, 4).map((pillar, idx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PillarIcon, { className: "w-5 h-5 gold-text" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black gold-text tracking-wider", children: pillar.num }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground", children: pillar.title })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-3", children: pillar.desc }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-accent/50 rounded-lg p-3 border border-amber-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-foreground/70 italic leading-relaxed", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold gold-text not-italic", children: [
                    "Ramayana insight:",
                    " "
                  ] }),
                  pillar.detail
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LastIcon, { className: "w-5 h-5 gold-text" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black gold-text tracking-wider", children: lastPillar.num }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground", children: lastPillar.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-3", children: lastPillar.desc }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-accent/50 rounded-lg p-3 border border-amber-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-foreground/70 italic leading-relaxed", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold gold-text not-italic", children: [
                  "Ramayana insight:",
                  " "
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 warm-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "Visual Model" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl font-bold text-foreground mt-2 mb-3", children: "The HEM Flow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-xl mx-auto", children: "A sequential, iterative execution loop that mirrors both Hanuman's journey and the modern Agile sprint cycle." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade hidden md:flex items-center justify-center gap-0 flex-wrap", children: FLOW_STEPS.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `w-16 h-16 rounded-full border-2 flex items-center justify-center font-bold text-sm shadow-card ${step === "Delivery" ? "gold-bg text-white border-transparent shadow-gold" : "bg-white gold-border gold-text"}`,
              children: idx + 1
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground whitespace-nowrap", children: step })
        ] }),
        idx < FLOW_STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-5 px-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-amber-300" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-0 h-0",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade md:hidden space-y-3 max-w-xs mx-auto", children: FLOW_STEPS.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `w-10 h-10 rounded-full border-2 flex items-center justify-center font-bold text-sm shrink-0 ${step === "Delivery" ? "gold-bg text-white border-transparent" : "bg-white gold-border gold-text"}`,
            children: idx + 1
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: step }),
        idx < FLOW_STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto w-5 h-5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0.5 h-4 bg-amber-300" }) })
      ] }, step)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-fade text-center text-xs text-muted-foreground mt-10 max-w-md mx-auto", children: "Each phase feeds into the next. After Delivery, teams loop back to Purpose for the next sprint — creating a continuous dharmic execution cycle." })
    ] }) })
  ] });
}
const PILLARS = [
  { num: "01", title: "Purpose Alignment", icon: Target },
  { num: "02", title: "Strategic Planning", icon: Map$1 },
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 bg-accent rounded-full text-xs font-semibold gold-text mb-6 border border-amber-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3 h-3" }),
          "Ancient Wisdom for Modern Engineering"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-serif text-4xl sm:text-5xl lg:text-[52px] font-normal leading-tight text-foreground mb-4", children: [
          "Hanuman",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text italic", children: "Execution" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Model"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold text-foreground mb-2", children: "A Dharmic Framework for Project Execution in Technology" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-8 max-w-md", children: "HEM bridges India's ancient leadership wisdom from the Ramayana with modern software engineering practices — creating a principled, human-centered approach to technology project management." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl shadow-card border border-border p-6 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full gold-bg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-bold", children: "ॐ" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-sm text-foreground", children: "5 Pillars of HEM" })
              ] }),
              PILLARS.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-center gap-3 p-3 rounded-xl bg-accent/50 border border-amber-100",
                  style: { animationDelay: `${idx * 0.1}s` },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold gold-text w-6", children: p.num }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(p.icon, { className: "w-4 h-4 text-muted-foreground shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: p.title })
                  ]
                },
                p.num
              ))
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -right-4 w-24 h-24 rounded-full bg-amber-100/60 -z-10" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-6 -left-6 w-32 h-32 rounded-full bg-orange-100/40 -z-10" })
          ] })
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl font-bold text-foreground", children: "Explore the Project" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-2", children: "Dive into any section of the Hanuman Execution Model" })
      ] }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(card.icon, { className: "w-5 h-5 gold-text" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 bg-amber-100 gold-text rounded-full", children: card.tag })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground mb-2", children: card.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed flex-1 mb-5", children: card.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 warm-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-3 gap-6 text-center", children: [
      { value: "5", label: "Core Pillars" },
      { value: "3000+", label: "Years of Wisdom" },
      { value: "∞", label: "Applications" }
    ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl font-black gold-text mb-1", children: stat.value }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-muted-foreground", children: stat.label })
    ] }, stat.label)) }) }) })
  ] });
}
const LOCATIONS = [
  {
    ...
    story: "In the forests of Kishkindha (present-day Karnataka), Hanuman formed a powerful alliance with Rama, gathered intelligence about Lanka, and helped organize the Vanara army for the mission. Every detail was planned before a single step was taken toward the south.",
    phaseDesc: "Project teams must define objectives, identify stakeholders, build alliances, and create a detailed plan before any execution begins. Rushing into execution without alignment leads to chaos.",
    color: "#C9A46A"
  },
  {
    id: "ocean",
    ...
    story: "Hanuman stood at the southern tip of India and leapt 100 yojanas across the ocean — an act that required absolute conviction, overcoming self-doubt, and trusting in his own capabilities. No map, no safety net, no guarantee of return.",
    phaseDesc: "Every high-impact project requires a moment of bold commitment. Teams must ship despite uncertainty, launch despite imperfection, and trust in their preparation when facing the unknown.",
    color: "#E07B4A"
  },
  {
    id: "lanka",
    ...
    story: "In Lanka, Hanuman executed flawlessly: he found Sita, delivered Rama's message, assessed Lanka's defenses, destroyed the Ashoka Vatika to send a message, and set Lanka's towers ablaze — then returned to report everything with perfect clarity and transparency.",
    phaseDesc: "The execution phase demands adaptability (Hanuman changed strategies multiple times) and transparent communication (his report to Rama aligned the entire army for the final battle).",
    color: "#B5552A"
  }
];
function JourneyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-28 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "Interactive Map" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-3", children: "Hanuman's Journey" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-xl mx-auto", children: "An Interactive Map of the Mission. Click each location to discover what Hanuman did there and the corresponding project management phase." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade grid lg:grid-cols-2 gap-8 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl border border-border shadow-card p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground text-center mb-4 uppercase tracking-wider", children: "India & Sri Lanka — Click the markers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              viewBox: "0 0 180 220",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Interactive map of Hanuman's journey from Kishkindha to Lanka" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "180", height: "220", fill: "#EFF6FF", rx: "12" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "ellipse",
                  {
                    cx: "130",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "85", y: "40", fontSize: "5", fill: "#92400E", opacity: "0.5", children: "Gangetic Plain" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "145", y: "150", fontSize: "5", fill: "#3B82F6", opacity: "0.7", children: "Bay of" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "143", y: "157", fontSize: "5", fill: "#3B82F6", opacity: "0.7", children: "Bengal" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "8", y: "145", fontSize: "5", fill: "#3B82F6", opacity: "0.7", children: "Arabian" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "10", y: "152", fontSize: "5", fill: "#3B82F6", opacity: "0.7", children: "Sea" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "105", y: "200", fontSize: "5", fill: "#92400E", opacity: "0.5", children: "Indian Ocean" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "path",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: selectedLoc ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: selectedLoc.label })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: selectedLoc.phase
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-5", children: selectedLoc.story }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-accent/60 rounded-xl p-4 border border-amber-200", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider gold-text mb-2", children: "Project Phase" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: selectedLoc.phaseDesc })
              ] })
            ]
          },
          selectedLoc.id
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-accent flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", role: "img", "aria-label": "map", children: "🗺️" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-foreground mb-2", children: "Click a location" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Select Kishkindha, Ocean, or Lanka on the map to explore what Hanuman did there and the corresponding project management phase." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex flex-col gap-2", children: LOCATIONS.map((loc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade mt-10 grid sm:grid-cols-3 gap-4", children: LOCATIONS.map((loc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: () => setSelected(loc.id),
          "data-ocid": `journey.${loc.id}.button`,
          className: `rounded-xl p-4 border text-left transition-all hover-lift ${selected === loc.id ? "border-amber-400 bg-amber-50" : "border-border bg-white hover:border-amber-200"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-sm text-foreground mb-1", children: loc.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: loc.phase })
          ]
        },
        loc.id
      )) })
...
const STORY_CARDS = [
  {
    ...
    highlight: "Think of him as the ultimate team player — skilled, focused, and driven by purpose rather than personal gain."
  },
  {
    step: "02",
    icon: Heart,
    ...
    highlight: "The mission: scout the unknown, gather critical intelligence, and return — all without backup."
  },
  {
    step: "03",
    icon: Mountain,
    ...
    highlight: "Purpose guided him. Planning prepared him. Courage moved him. Adaptability saved him. Communication completed the mission."
  },
  {
    step: "04",
    icon: Lightbulb,
    ...
    highlight: "Hanuman's journey maps to: Purpose → Plan → Execute → Adapt → Communicate. That's the HEM Framework."
  }
];
const JOURNEY_STEPS = [
...
function StoryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-28 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "The Story" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-4", children: "The Story Behind the Model" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "Never heard of the Ramayana? That's perfectly fine. This page explains everything from scratch — who Hanuman is, what he did, and why his journey became the foundation for a modern project framework." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: STORY_CARDS.map((card, idx) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 p-7 pb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-12 h-12 rounded-xl bg-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardIcon, { className: "w-5 h-5 gold-text" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black gold-text tracking-wider", children: card.step }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: card.summary })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: card.title })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-7 pb-4 space-y-3", children: card.paragraphs.map((para) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-7 mb-7 p-4 bg-accent/60 border border-amber-200 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground/80 italic leading-relaxed", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold gold-text not-italic", children: [
                "Key insight:",
                " "
              ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 warm-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "The Pattern" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl font-bold text-foreground mt-2 mb-3", children: "Hanuman's Journey in 5 Steps" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-xl mx-auto", children: "Look closely and you'll see the same pattern that powers every successful modern project." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade hidden md:flex items-start justify-center gap-0 flex-wrap", children: JOURNEY_STEPS.map((step, idx) => {
        const StepIcon = step.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 w-28", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full border-2 gold-border bg-white flex items-center justify-center shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StepIcon, { className: "w-5 h-5 gold-text" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-foreground", children: step.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground text-center", children: step.sub })
          ] }),
          idx < JOURNEY_STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-8 px-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-0.5 bg-amber-300" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "w-0 h-0",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-fade md:hidden space-y-4 max-w-xs mx-auto", children: JOURNEY_STEPS.map((step) => {
        const StepIcon = step.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full gold-border border-2 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StepIcon, { className: "w-4 h-4 gold-text" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-foreground", children: step.label }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade bg-white rounded-2xl border border-border shadow-card p-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground mb-2", children: "Ready to See the Full Framework?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6", children: "Now that you know the story, explore how HEM translates it into a 5-pillar model for modern project execution." }),
...
function IconCard({ icon: Icon2, title, desc, index: index2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-accent flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 gold-text" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-foreground mb-2", children: title }),
...
function WhyItMattersPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-28 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest gold-text", children: "Relevance" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-4", children: "Why It Matters" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "In a world of fast-moving technology, it's easy to focus only on what you can build. HEM asks a deeper question: how should you build it, and why?" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 gold-text" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Why Engineers Need This" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2 ml-11", children: "Engineering is more than writing code. It is decision-making under pressure, with real consequences." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-5", children: ENGINEER_CARDS.map((card, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        IconCard,
        {
          icon: card.icon,
          title: card.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 warm-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-white border border-border flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4 gold-text" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Why Planning Matters" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2 ml-11", children: "The Ramayana shows us: Hanuman didn't just leap. He prepared." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-5", children: PLANNING_CARDS.map((card, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        IconCard,
        {
          icon: card.icon,
          title: card.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mt-16 mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-4 h-4 gold-text" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Why Ancient Wisdom is Relevant" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2 ml-11", children: "3,000 years old. Still accurate." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-5", children: WISDOM_CARDS.map((card, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        IconCard,
        {
          icon: card.icon,
          title: card.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "section-fade rounded-2xl p-8 text-center border-2 gold-border bg-accent/30",
        "data-ocid": "why.card",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full gold-bg flex items-center justify-center mx-auto mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-lg font-bold", children: "ॐ" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "text-lg sm:text-xl font-semibold text-foreground leading-relaxed mb-4", children: [
            "“Engineering without ethics is just clever problem-solving.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: " HEM adds the human dimension.”" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "The Hanuman Execution Model — A Framework for Project Management in Technology" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-fade text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "Ready to see how HEM wraps up?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
function Nav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              "data-ocid": "nav.link",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full gold-bg flex items-center justify-center shadow-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm font-bold", children: "ॐ" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:block", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-foreground leading-none", children: "HEM" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground leading-none mt-0.5", children: "Hanuman Execution Model" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-0.5", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => handleNav(link.id),
              "data-ocid": "nav.link",
              className: `px-3 py-1.5 text-sm font-medium rounded-md transition-colors ${currentPage === link.id ? "gold-text nav-link-active" : "text-muted-foreground hover:text-foreground"}`,
              children: link.label
            },
            link.id
          )) }),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-white border-t border-border px-4 py-3 flex flex-col gap-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => handleNav(link.id),
            "data-ocid": "nav.link",
            className: `text-sm font-medium text-left py-2.5 px-3 rounded-lg transition-colors ${currentPage === link.id ? "gold-text bg-accent" : "text-foreground hover:bg-accent/50"}`,
            children: link.label
          },
          link.id
        )) })
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full gold-bg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-bold", children: "ॐ" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: "Hanuman Execution Model" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "A Dharmic Framework for Project Execution in Technology. Ancient Wisdom for Modern Engineering." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-muted-foreground mb-3", children: "Navigate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border pt-6 text-xs text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      "© ",
      year,
      " Hanuman Execution Model. All rights reserved."
    ] }) })
  ] }) });
}
function PageContent() {
  ...
  const pageMap = {
    home: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}),
    story: /* @__PURE__ */ jsxRuntimeExports.jsx(StoryPage, {}),
    journey: /* @__PURE__ */ jsxRuntimeExports.jsx(JourneyPage, {}),
    framework: /* @__PURE__ */ jsxRuntimeExports.jsx(FrameworkPage, {}),
    "case-study": /* @__PURE__ */ jsxRuntimeExports.jsx(CaseStudyPage, {}),
    why: /* @__PURE__ */ jsxRuntimeExports.jsx(WhyItMattersPage, {}),
    conclusion: /* @__PURE__ */ jsxRuntimeExports.jsx(ConclusionPage, {})
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "main",
    {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, {}) });
}
